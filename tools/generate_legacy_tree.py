...
def effects_for(source_name: str, display_name: str, icon: str) -> list[str]:
    ...
    bespoke.update({
        ...
        "newfocus_63": [
            ...
            "if = { limit = { has_dlc = \"No Step Back\" } add_equipment_to_stockpile = { type = medium_tank_chassis_1 amount = 120 producer = B80 } }",
        ...
        "newfocus_64": [
            ...
            "if = { limit = { has_dlc = \"No Step Back\" } add_equipment_to_stockpile = { type = heavy_tank_chassis_1 amount = 60 producer = B80 } }",
